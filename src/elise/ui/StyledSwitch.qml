...
// Port of Caelestia's components/controls/StyledSwitch.qml — M3 switch with the
// animated check/cross thumb. Verbatim apart from import sources and the
// `root.Tokens` → `Tokens` singleton references.
Switch {
    id: root
