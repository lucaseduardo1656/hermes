...
// 1-1 port of Caelestia's components/controls/StyledSlider.qml. WavyLine is now
// the native C++ type registered into the Elise module, so the wavy fill path
// is faithful. Verbatim apart from import sources.
Slider {
    id: root
