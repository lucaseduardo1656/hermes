...
// 1-1 port of Caelestia's components/controls/StyledProgressBar.qml — M3 linear
// progress (determinate + indeterminate) using the native LinearIndicatorManager
// and WavyLine. Verbatim apart from import sources.
ProgressBar {
    id: root
