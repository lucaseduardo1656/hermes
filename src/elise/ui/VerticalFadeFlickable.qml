...
// Port of Caelestia's components/containers/VerticalFadeFlickable.qml — a
// Flickable that fades its content out at the top/bottom edges as it scrolls
// (the signature Caelestia scroll behavior). Verbatim apart from import sources.
StyledFlickable {
    id: root
