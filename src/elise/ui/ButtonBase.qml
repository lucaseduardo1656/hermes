...
// Port of Caelestia's components/controls/ButtonBase.qml — the M3 button shell
// (filled/tonal/text, toggle, radius morph) over a StateLayer ripple. Verbatim
// apart from import sources.
StyledRect {
    id: root
