...
// Material Symbols Rounded name -> PUA codepoint map (Google's .codepoints).
// Used by MaterialIcon to render glyphs by codepoint, since this Qt build
// does not apply the font's ligatures.
QtObject {
